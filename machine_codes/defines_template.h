...
/*
constexpr static unsigned char cmd_MOV_REG_RAXMEM_DISPL32[cmd_REGSNUM][3] = {
{cmd_MOV_RAXRAX_MEM_DISPL32},
{cmd_MOV_RCXRAX_MEM_DISPL32},
{cmd_MOV_RDXRAX_MEM_DISPL32},
{cmd_MOV_RBXRAX_MEM_DISPL32},
{cmd_MOV_RSPRAX_MEM_DISPL32},
{cmd_MOV_RBPRAX_MEM_DISPL32},
{cmd_MOV_RSIRAX_MEM_DISPL32},
{cmd_MOV_RDIRAX_MEM_DISPL32},
{cmd_MOV_R8RAX_MEM_DISPL32},
{cmd_MOV_R9RAX_MEM_DISPL32},
{cmd_MOV_R10RAX_MEM_DISPL32},
{cmd_MOV_R11RAX_MEM_DISPL32},
{cmd_MOV_R12RAX_MEM_DISPL32},
{cmd_MOV_R13RAX_MEM_DISPL32},
{cmd_MOV_R14RAX_MEM_DISPL32},
{cmd_MOV_R15RAX_MEM_DISPL32},
};

constexpr static unsigned char cmd_MOV_RAXMEM_REG_DISPL32[cmd_REGSNUM][3] = {
{cmd_MOV_MEM_RAX_DISPL32RAX},
{cmd_MOV_MEM_RAX_DISPL32RCX},
{cmd_MOV_MEM_RAX_DISPL32RDX},
{cmd_MOV_MEM_RAX_DISPL32RBX},
{cmd_MOV_MEM_RAX_DISPL32RSP},
{cmd_MOV_MEM_RAX_DISPL32RBP},
{cmd_MOV_MEM_RAX_DISPL32RSI},
{cmd_MOV_MEM_RAX_DISPL32RDI},
{cmd_MOV_MEM_RAX_DISPL32R8},
{cmd_MOV_MEM_RAX_DISPL32R9},
{cmd_MOV_MEM_RAX_DISPL32R10},
{cmd_MOV_MEM_RAX_DISPL32R11},
{cmd_MOV_MEM_RAX_DISPL32R12},
{cmd_MOV_MEM_RAX_DISPL32R13},
{cmd_MOV_MEM_RAX_DISPL32R14},
{cmd_MOV_MEM_RAX_DISPL32R15},
};
*/
